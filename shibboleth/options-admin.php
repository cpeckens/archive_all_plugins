...
add_action('network_admin_menu', 'shibboleth_admin_panels'); //Added by CMP to add admin panel under Network Administration
...
function shibboleth_admin_panels() {
	...
	if ( function_exists('is_site_admin') ) {
		$hookname = add_submenu_page('settings.php', __('Shibboleth Options', 'shibboleth'), //Modified by CMP - changed wpmu-admin.php (deprecated) to settings.php
